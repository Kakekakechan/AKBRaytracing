...
def psf_calc(matrixWave2_Corrected, grid_H, grid_V, defocusWave):
    ...
    if option_energy == 'EUV':
        ...
        wavelength_m = 1.35e-10
    elif option_energy == 'softXray':
        wavelength_m = 1.35e-9
    ...
    if optKBdesign:
        ...
        if option_HighNA == True:
            if designparams is None:
                # 論文用　あえてでかい
                if option_energy == 'EUV':
                    l1h, l2h, inc_h, mlen_h, wd_v, inc_v, mlen_v = [np.float64(146.), np.float64(0.5),  np.float64(0.25), np.float64(0.46), np.float64(0.082), np.float64(0.25), np.float64(0.14)]
                elif option_energy == 'hardXray':
                    l1h, l2h, inc_h, mlen_h, wd_v, inc_v, mlen_v = [np.float64(146.), np.float64(0.5),  np.float64(0.25/100), np.float64(0.46), np.float64(0.082), np.float64(0.25/100), np.float64(0.14)]
                elif option_energy == 'softXray':
                    ### 1000eV 25mrad AL coat
                    ### 1000eV 25mrad AL coat
                    l1h, l2h, inc_h, mlen_h, wd_v, inc_v, mlen_v = [np.float64(146.), np.float64(0.5),  np.float64(0.25/10), np.float64(0.46), np.float64(0.082), np.float64(0.25/10), np.float64(0.14)]
